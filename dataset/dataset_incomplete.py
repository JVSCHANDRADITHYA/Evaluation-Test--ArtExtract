...
custom dataset for the incompletely labelled WikiArt dataset. The dataset class is called WikiArtDataset and consists of three labels artist, genre and style. 
...
class inWikiArtDataset(Dataset):
...
if __name__ == '__main__' : 
    ...
    dataset = inWikiArtDataset(artist_csv=artist_csv, genre_csv=genres_csv, style_csv=styles_csv, img_dir=img_dir, transform=tran)
